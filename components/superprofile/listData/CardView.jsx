                        ...
                        products.map((product, index) => (
                            <div key={index} className="rounded-lg overflow-hidden shadow-lg">
                                <div className="relative">
                                    ...
                                    <div className="text-sm absolute top-0 right-9 bg-white px-4 text-black rounded-full h-8 w-8 flex flex-col items-center justify-center mt-3 mr-3">
                                        <EditPaymentPopover productID={product._id} />
                                    </div>

                                    <a href="!#">
                                        <div
                                            className="text-sm  absolute top-0 right-0 bg-white px-4 text-black rounded-full h-8 w-8 flex flex-col items-center justify-center mt-3 mr-3 ">
